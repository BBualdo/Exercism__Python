...
def clean_ingredients(dish_name:str, dish_ingredients:list) -> tuple[str, set]:
...
def check_drinks(drink_name:str, drink_ingredients:list) -> str:
    ...
    for ingredient in drink_ingredients:
        if ingredient in ALCOHOLS: return f"{drink_name} Cocktail"
...
def tag_special_ingredients(dish:tuple[str, list|set]) -> tuple[str, set]:
...
def singleton_ingredients(dishes:list, intersection:set) -> set:
    ...
    for dish in dishes:
        singletons |= dish.difference(intersection)
